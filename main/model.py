...
class Code2NaturalLanguage(object):
    ...
    def __init__(self, args, src_dict, tgt_dict, ast_dict, state_dict=None):
        # Book-keeping.
        self.args = args
    ...
    def update(self, ex):
        ...
        if self.use_cuda:
            ...
            ast_len = ast_len.cuda(non_blocking = True)
    ...
    def load(filename, new_args=None):
        ...
        return Code2NaturalLanguage(args, src_dict, tgt_dict, ast_dict, state_dict)
    ...
    def load_checkpoint(filename, use_gpu=True):
        ...
        args = saved_params['args']
        model = Code2NaturalLanguage(args, src_dict, tgt_dict, ast_dict, state_dict)
