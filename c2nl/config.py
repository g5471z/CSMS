...
def add_model_args(parser):
    ...
    data.add_argument('--max_ast_len', type=int, default=100,
                      help='Maximum allowed length for the ast sequence')
    ...
    model.add_argument('--ast_pos_emb', type='bool', default=True,
                       help='Use positional embeddings in encoder')
    ...
    model.add_argument('--use_asts', type='bool', default=False,
                       help='Use ast node')
